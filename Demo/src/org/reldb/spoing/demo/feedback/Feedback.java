...
public class Feedback {
	...
	private class SendWorker extends Thread {
		...
		public void publish(SendProgress progressMessage) {
			lblProgress.getDisplay().asyncExec(() -> updateProgress(progressMessage.msg, progressMessage.progress));
		}
		...
		protected SendStatus doInBackground() throws Exception {
			...
			try {
				...
				formparams.add(new BasicNameValuePair("SpoingErrorReport", report));
